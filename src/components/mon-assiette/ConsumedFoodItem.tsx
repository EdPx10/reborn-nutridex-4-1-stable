    ...
    <div className="bg-white rounded-lg border border-gray-100 p-4 flex items-center gap-3">
      ...
      <div className="flex-grow">
        <div className="flex justify-between items-start">
          <div>
            <Link to={`/aliment/${food.id}`} className="hover:text-nutri-green transition-colors">
          ...
          <div className="flex items-center">
            ...
            <button 
              ...
              aria-label="Supprimer de mon assiette"
            >
              <Trash2 size={16} />
            </button>
          </div>
        ...
        <Link to={`/aliment/${food.id}`} className="block mt-2">
